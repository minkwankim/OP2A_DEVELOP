//
//  primitive_variables_fluid17.cpp
//  OP2A
//
...
void variableMapCFD_fluid_17::UtoQ(std::vector<double>& U, std::vector<species>& speciesdata, std::vector<double>& Q)
{
...
void variableMapCFD_fluid_17::UtoW(std::vector<double>& U, std::vector<species>& speciesdata, std::vector<double>& W)
{
...
void variableMapCFD_fluid_17::QtoU(std::vector<double>& Q, std::vector<species>& speciesdata, std::vector<double>& U)
{
    ...
    double Eelc  = Q[Qid(2,2)];     // Electronic energy
    double Ee    = Q[Qid(3,2)];     // Electron energy
    ...
    double E_temp = E - E_ke - E_h0- Ev - Eelc - Ee;
