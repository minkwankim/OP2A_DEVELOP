//
//  primitive_variables_fluid11.cpp
//  OP2A
//
...
void variableMapCFD_fluid_11::UtoQ(std::vector<double>& U, std::vector<species>& speciesdata, std::vector<double>& Q)
{
...
void variableMapCFD_fluid_11::UtoW(std::vector<double>& U, std::vector<species>& speciesdata, std::vector<double>& W)
{
...
void variableMapCFD_fluid_11::QtoU(std::vector<double>& Q, std::vector<species>& speciesdata, std::vector<double>& U)
{
