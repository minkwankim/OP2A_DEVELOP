//
//  primitive_variables_fluid4.cpp
//  OP2A
//
...
void variableMapCFD_fluid_4::UtoQ(std::vector<double>& U, std::vector<species>& speciesdata, std::vector<double>& Q)
{
    ...
    for (int s = 0; s < NS; s++)
    {
        ...
        {
            e    = speciesdata[s].basic.Cv[0]*Tee;
...
void variableMapCFD_fluid_4::UtoW(std::vector<double>& U, std::vector<species>& speciesdata, std::vector<double>& W)
{
...
void variableMapCFD_fluid_4::QtoU(std::vector<double>& Q, std::vector<species>& speciesdata, std::vector<double>& U)
{
    ...
    double Eee   = Q[Qid(1,2)];     // Electronic-Electron energy
