//
//  primitive_variables_fluid12.cpp
//  OP2A
//
...
void variableMapCFD_fluid_12::UtoQ(std::vector<double>& U, std::vector<species>& speciesdata, std::vector<double>& Q)
{
...
void variableMapCFD_fluid_12::UtoW(std::vector<double>& U, std::vector<species>& speciesdata, std::vector<double>& W)
{
...
void variableMapCFD_fluid_12::QtoU(std::vector<double>& Q, std::vector<species>& speciesdata, std::vector<double>& U)
{
    ...
    NEQ_ve Temp_ve(10000, 1.0e-8);
    Tv   = Temp_ve.solveTemp(U, speciesdata, Ev, NS);
    
    
    // Translatonal temperature
    double E_temp = E - E_ke - E_h0- Ev;
